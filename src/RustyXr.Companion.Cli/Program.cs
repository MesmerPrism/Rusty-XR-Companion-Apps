...
internal static class CliProgram
{
    ...
    private static async Task<int> BrokerShellHelperRunAsync(ArgOptions options, bool disconnect)
    {
        ...
        var run = await new BrokerShellHelperService()
            .RunAsync(new BrokerShellHelperRunOptions(
                ...
                NoBrokerReport: options.Has("--no-broker-report"),
                ...
                ProximityWatchdog: options.Has("--proximity-watchdog"),
                StopProximityWatchdog: options.Has("--stop-proximity-watchdog") || disconnect,
                ProximityWatchdogUntilStopped: options.Has("--proximity-watchdog-until-stopped"),
                ProximityWatchdogEnsureStayAwake: options.Has("--proximity-watchdog-ensure-stay-awake"),
                ProximityWatchdogDurationMs: ParseInt(
                    options,
                    "--proximity-watchdog-duration-ms",
                    BrokerShellHelperDefaults.ProximityWatchdogDefaultDurationMs),
                ProximityWatchdogHoldDurationMs: ParseInt(
                    options,
                    "--proximity-watchdog-hold-duration-ms",
                    BrokerShellHelperDefaults.ProximityWatchdogDefaultHoldDurationMs),
                ProximityWatchdogIntervalMs: ParseInt(
                    options,
    ...
    private static void WriteHelp()
    {
        ...
        Commands:
          ...
          broker shell-helper start --serial <serial> [--rusty-xr-root <folder>] [--helper-jar <path>] [--no-build] [--no-broker-report] [--probe-codecs] [--probe-cameras] [--probe-camera-open] [--camera-open-id <id>] [--emit-synthetic-video-metadata] [--synthetic-video-samples <0-30>] [--emit-synthetic-video-binary] [--emit-mediacodec-synthetic-video] [--emit-screenrecord-video] [--binary-video-port <n>] [--binary-video-packets <1-30>] [--binary-video-packet-bytes <1-65536>] [--encoded-video-frames <1-60>] [--encoded-video-width <n>] [--encoded-video-height <n>] [--encoded-video-bitrate <bps>] [--screenrecord-time-limit <1-3>] [--proximity-watchdog] [--proximity-watchdog-until-stopped] [--proximity-watchdog-ensure-stay-awake] [--proximity-watchdog-duration-ms <n>] [--proximity-watchdog-hold-duration-ms <n>] [--proximity-watchdog-interval-ms <n>] [--focus-guardian] [--focus-guardian-mode <mode>] [--focus-target-package <package>] [--focus-target-activity <activity>] [--host-port <n>] [--device-port <n>] [--broker-host 127.0.0.1] [--broker-port <n>] [--skip-status] [--json]
